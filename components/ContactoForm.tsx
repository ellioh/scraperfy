...
export interface PlanOpcion {
  value: string; // nombre del servicio: es lo que se guarda en solicitudes.plan
  label: string; // nombre + precio, solo para mostrar
}

export default function ContactoForm({ planes, planInicial }: { planes: PlanOpcion[]; planInicial: string }) {
  const [form, setForm] = useState({
    nombre: "", email: "", empresa: "", url_objetivo: "",
    frecuencia: "", formato: "", descripcion: "", plan: planInicial,
  });
      ...
      <div className="max-w-xl mx-auto px-4 pt-14">
        ...
        {estado === "ok" ? (
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div>
              <label className="text-xs text-gray-400 block mb-1.5">Servicio de interés</label>
